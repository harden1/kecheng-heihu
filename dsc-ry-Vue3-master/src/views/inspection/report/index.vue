<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="reportList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="报工类型，如“自动”、“手动”等" align="center" prop="reportType" />
      <el-table-column label="报工数量" align="center" prop="quantity" />
      <el-table-column label="返回json内容" align="center" prop="resultJson" />
      <el-table-column label="成功状态，true表示成功" align="center" prop="successFlag" />
      <el-table-column label="不良项备注" align="center" prop="defectRemark" />
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template #default="scope">
          <el-button link type="primary" icon="Edit" @click="handleUpdate(scope.row)" v-hasPermi="['inspection:report:edit']">修改</el-button>
